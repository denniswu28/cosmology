...
hist_lens, bins_lens = np.histogram(nz_lens, bins = 500, range=(0,5), density = True)
bins_lens  = bins_lens[0:-1]
hist_source, bins_source = np.histogram(nz_source, bins = 500, range=(0,5), density = True)
