...
r_dir = "/hpc/group/cosmology/denniswu/cosmosis_files/output/CosmoDC2/data_vector_full/2pt_angle.txt"
r_cut_dir = "/hpc/group/cosmology/denniswu/cosmosis_files/output/CosmoDC2/data_vector/2pt_angle.txt"
xi_data_dir = "/hpc/group/cosmology/denniswu/cosmosis_files/output/CosmoDC2/data_vector_full/2pt_data.txt"
xi_data_cut_dir = "/hpc/group/cosmology/denniswu/cosmosis_files/output/CosmoDC2/data_vector/2pt_data.txt"
xi_theory_dir = "/hpc/group/cosmology/denniswu/cosmosis_files/output/CosmoDC2/data_vector_full/2pt_theory.txt"
xi_theory_cut_dir = "/hpc/group/cosmology/denniswu/cosmosis_files/output/CosmoDC2/data_vector/2pt_theory.txt"
xi_bin1_dir = "/hpc/group/cosmology/denniswu/cosmosis_files/output/CosmoDC2/data_vector_full/2pt_bin1.txt"
xi_bin2_dir = "/hpc/group/cosmology/denniswu/cosmosis_files/output/CosmoDC2/data_vector_full/2pt_bin2.txt"
xi_bin1_cut_dir = "/hpc/group/cosmology/denniswu/cosmosis_files/output/CosmoDC2/data_vector/2pt_bin1.txt"
xi_bin2_cut_dir = "/hpc/group/cosmology/denniswu/cosmosis_files/output/CosmoDC2/data_vector/2pt_bin2.txt"
...
# axs[1, 0].plot(r_cut[14:21], xi_data_cut[14:21], linestyle="",marker=".", color='red', label = r'CosmoDC2 after-cut Truth $\gamma_t (\theta)$')
axs[1, 0].plot(r[40:60], xi_theory[40:60], linestyle="solid",marker="", color='navy', label = r'CosmoDC2 best-fit theory $\gamma_t (\theta)$')
# axs[1, 0].plot(r_cut[14:21], xi_theory_cut[14:21], linestyle="solid",marker="", color='red', label = r'CosmoDC2 after_cut best-fit theory $\gamma_t (\theta)$')
...
# axs[1, 1].plot(r_cut[21:36], xi_data_cut[21:36], linestyle="",marker=".", color='red', label = r'CosmoDC2 after-cut Truth $\omega (\theta)$')
axs[1, 1].plot(r[60:80], xi_theory[60:80], linestyle="solid",marker="", color='navy', label = r'CosmoDC2 best-fit theory $\omega (\theta)$')
# axs[1, 1].plot(r_cut[21:36], xi_theory_cut[21:36], linestyle="solid",marker="", color='red', label = r'CosmoDC2 after-cut best-fit theory $\omega (\theta)$')
...
fig.savefig('/hpc/group/cosmology/denniswu/cosmosis_files/sample/shear_2.png')
