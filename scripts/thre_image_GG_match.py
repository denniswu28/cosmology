...
with open('data/s1_match.csv') as fs1:
	reader = csv.reader(fs1, delimiter=',')
	for row in reader:
		s1 = row

with open('data/s2_match.csv') as fs2:
...
for i in range(20,26):
	...
	dc2_truth_thre = dc2_truth_match[dc2_truth_match['mag_'+fr[fr_num]] < mag_threshold]
	...
	with open('data/s1_thre_match_'+ str(mag_threshold) +'.csv') as fst1:
		reader = csv.reader(fst1, delimiter=',')
		for row in reader:
			s1_thre = row

	with open('data/s2_thre_match_'+ str(mag_threshold) +'.csv') as fst2:
	...
	gg.write("data/gg_corr_match_all.fits")
	gg_thre.write("data/gg_corr_match_"+ str(mag_threshold) +".fits")
	gg_cross.write("data/gg_cross_match_"+ str(mag_threshold) +".fits")
